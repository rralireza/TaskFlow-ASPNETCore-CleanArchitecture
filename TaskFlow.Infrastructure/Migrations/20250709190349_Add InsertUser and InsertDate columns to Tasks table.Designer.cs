...
namespace TaskFlow.Infrastructure.Migrations
{
    ...
    [Migration("20250709190349_Add InsertUser and InsertDate columns to Tasks table")]
    partial class AddInsertUserandInsertDatecolumnstoTaskstable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.TaskItem", b =>
                {
                    ...
                    b.Property<Guid?>("InsertUserDetailsId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("InsertUserDetailsId");
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.TaskItem", b =>
                {
                    ...
                    b.HasOne("TaskFlow.Domain.Entities.User", "InsertUserDetails")
                        .WithMany()
                        .HasForeignKey("InsertUserDetailsId");
